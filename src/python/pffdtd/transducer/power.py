...
def plot_transducer_power_requirements(df, drivers, SPL_target=108):
    ...
    plt.vlines(SPL_target, 0, 400, linestyles='--',
...
def main(spl_target, driver_db):
    ...
    plot_transducer_power_requirements(df, drivers, SPL_target=spl_target)
