...
# Post-process
pffdtd sim3d process-outputs --sim_dir="$sim_dir" --resample_Fs 48000 --fcut_lowpass "$fmax" --order_lowpass=8 --symmetric_lowpass --fcut_lowcut "$fmin" --order_lowcut=4 --air_abs_filter="modal" --save_wav --plot
...
pffdtd analysis rt60 --fmin=$fmin --fmax="$fmax" --target=0.21 $sim_dir/R001_out_normalised.wav
