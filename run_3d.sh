...
# Post-process
pffdtd sim3d process-outputs --sim_dir="$sim_dir" --resample_fs 48000.0 --fcut_lowpass "$fmax" --order_lowpass=8 --symmetric_lowpass --fcut_lowcut "$fmin" --order_lowcut=4 --air_abs_filter="none" --save_wav
